...
public class PushIntentService extends GTIntentService {
    ...
    public void onReceiveServicePid(Context context, int pid) {
      ...
      param.putString("type", GetuiModule.EVENT_TYPE_SERVER_PID);
      param.putInt("pid", pid);
      GetuiModule.sendEvent(GetuiModule.EVENT_SERVER_PID,  param);
    }
    ...
    public void onReceiveClientId(Context context, String clientId) {
        ...
        WritableMap param = Arguments.createMap();
        param.putString("type", GetuiModule.EVENT_TYPE_CID);
        param.putString("cid", clientId);
        GetuiModule.sendEvent(GetuiModule.EVENT_CLIENT_ID,  param);
    }
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        ...
        GetuiModule.sendEvent(GetuiModule.EVENT_RECEIVE_MESSAGE_DATA, param );
    }
    ...
    public void onReceiveOnlineState(Context context, boolean online) {
      ...
      WritableMap param = Arguments.createMap();
      param.putString("type", GetuiModule.EVENT_TYPE_ONLINE_STATE);
      param.putBoolean("onlineState", online);
      GetuiModule.sendEvent(GetuiModule.EVENT_ONLINE_STATE, param);
    }
