...
public class GetuiModule extends ReactContextBaseJavaModule {
  ...
  public static final String EVENT_RECEIVE_REMOTE_NOTIFICATION = "getui_receiveRemoteNotification";
  public static final String EVENT_RECEIVE_MESSAGE_DATA = "getui_receiveMessageData";
  public static final String EVENT_ONLINE_STATE = "getui_onlineState";
  public static final String EVENT_CLIENT_ID = "getui_clientId";
  public static final String EVENT_SERVER_PID = "getui_serverPid";

  public static final String EVENT_TYPE_CID = "clientId";
  public static final String EVENT_TYPE_SERVER_PID = "serverPid";
  public static final String EVENT_TYPE_ONLINE_STATE = "onlineState";
  ...
  public void getClientId(Promise promise){
    promise.resolve(PushManager.getInstance().getClientid(mContext));
  }
  ...
  public void isPushTurnedOn(Promise promise){
    promise.resolve(PushManager.getInstance().isPushTurnedOn(mContext));
  }
  ...
  public void getVersion(Promise promise){
    promise.resolve(PushManager.getInstance().getVersion(mContext));
  }
