...
export declare type RemovableSubscription = () => void;
export declare type GetuiEventCallback<Event> = (event: Event) => void;
export declare const EVENT_RECEIVE_REMOTE_NOTIFICATION = "getui_receiveRemoteNotification";
export declare const EVENT_RECEIVE_MESSAGE_DATA = "getui_receiveMessageData";
export declare const EVENT_ONLINE_STATE = "getui_onlineState";
export declare const EVENT_CLIENT_ID = "getui_clientId";
export declare const EVENT_SERVER_PID = "getui_serverPid";
...
export declare type GetuiEventPayloadType = 'clientId' | 'serverPid' | 'onlineState' | 'payload' | 'cmd' | 'notificationArrived' | 'notificationClicked';
